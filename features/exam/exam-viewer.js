(function registerExamViewer(global) {
  ...
  function renderTimer(session, onExpire) {
    ...
    const urgency = totalSeconds <= 60 ? "critical" : totalSeconds <= 600 ? "warning" : "normal";
    const timer = dom.createElement("div", { className: "exam-timer", attributes: { "aria-live": "off", "data-urgency": urgency } }, [
      dom.createElement("span", { className: "exam-timer-label", text: session.mode === "exam" ? "آزمون" : "تمرین" }),
      dom.createElement("span", { className: "exam-timer-display", text: display })
    ]);
